...
namespace WebApiGitHubProgram.Controllers
{
    ...
    [ApiController]
        ...
        public class Attendence1Controller : ControllerBase
        {
            private readonly IMyCommunicator1 _myCommunicator;
            public IConfiguration Configuration { get; }
            public Attendence1Controller(IMyCommunicator1 myCommunicator, IConfiguration configuration)
            {
